...
if os.environ.get("ENV"):   # Add a ENV in Environment Variables if you wanna configure the bot via env vars.
  ...
  feed_url3 = os.environ.get("FEED_URL2")
  feed_url4 = os.environ.get("FEED_URL2") 
...
def check_feed3():
    ...
    if entry.id != db.get_link(feed_url3).link:
      ...
      print(f"Checked RSS FEED3 - TorrentFunk Movies")
...
def check_feed4():
    ...
    if entry.link != db.get_link(feed_url2).link:
      ...
      print(f"Checked RSS FEED4 - TorrentFunk TV")
